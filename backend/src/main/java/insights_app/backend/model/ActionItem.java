...
public class ActionItem {
    ...
    @JsonIgnoreProperties({"participants", "actionItems", "rawTranscript", "summary",
            "detailedNotes", "decisionsMade", "followUpNotes", "uploader",
            "meetingDate", "uploadDate", "processingStatus", "description"})
