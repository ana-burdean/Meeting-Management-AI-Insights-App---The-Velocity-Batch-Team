...
export default function MeetingDetailsPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-[#373D20]/65 p-4 backdrop-blur-sm">
      <aside className="max-h-[90vh] w-full max-w-4xl overflow-auto rounded-[2rem] bg-white p-6 shadow-2xl ring-1 ring-[#BCBD8B]/50">
        <div className="space-y-6">
          <div className="flex items-start justify-between gap-3 border-b border-[#BCBD8B]/50 pb-4">
            <div>
